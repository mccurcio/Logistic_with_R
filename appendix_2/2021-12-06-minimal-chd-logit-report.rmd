...
- The goal of this study is to determine which risk factors lead to a high probability of a person acquiring cardiovascular disease.

- The model is fit with 14 independent variables using the information from the 4,133 participants over a ten year period.

The five most important factors that effect the risk of acquiring cardiac heart disease are:
...
```{r}
xtabs(~TenYearCHD + prevalentStroke, data = df)
```
